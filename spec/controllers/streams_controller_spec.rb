...
RSpec.describe StreamsController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new stream as @stream" do
      ...
      expect(assigns(:stream)).to be_a_new(Stream)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created stream as @stream" do
        post :create, {:stream => valid_attributes}, valid_session
        expect(assigns(:stream)).to be_a(Stream)
        expect(assigns(:stream)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stream as @stream" do
        post :create, {:stream => invalid_attributes}, valid_session
        expect(assigns(:stream)).to be_a_new(Stream)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested stream" do
        stream = Stream.create! valid_attributes
        put :update, {:id => stream.to_param, :stream => new_attributes}, valid_session
        stream.reload
    ...
    describe "with invalid params" do
      it "assigns the stream as @stream" do
        stream = Stream.create! valid_attributes
        put :update, {:id => stream.to_param, :stream => invalid_attributes}, valid_session
        expect(assigns(:stream)).to eq(stream)
      end
