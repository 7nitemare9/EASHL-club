...
let(:highest) { OpenStruct.new( :player_team_stat => {
...
let(:middle) { OpenStruct.new( :player_team_stat => {
...
let(:lowest){  OpenStruct.new( :player_team_stat => { 
...
let(:hash) { [middle, lowest, highest] }
  ...
  it 'gets and sorts points' do
    Statistic.get_points(hash)[0].player_team_stat[:playername].should eq "Highest"
    Statistic.get_points(hash)[1].player_team_stat[:playername].should eq "Middle"
    Statistic.get_points(hash)[2].player_team_stat[:playername].should eq "Lowest"
  end

  it 'gets and sorts goals' do
    Statistic.get_goals(hash)[0].player_team_stat[:playername].should eq "Highest"
    Statistic.get_goals(hash)[1].player_team_stat[:playername].should eq "Middle"
    Statistic.get_goals(hash)[2].player_team_stat[:playername].should eq "Lowest"
  end

  it 'gets and sorts assists' do
    Statistic.get_assists(hash)[0].player_team_stat[:playername].should eq "Highest"
    Statistic.get_assists(hash)[1].player_team_stat[:playername].should eq "Middle"
    Statistic.get_assists(hash)[2].player_team_stat[:playername].should eq "Lowest"
  end

  it 'gets and sorts pims' do
    Statistic.get_pims(hash)[0].player_team_stat[:playername].should eq "Lowest"
    Statistic.get_pims(hash)[1].player_team_stat[:playername].should eq "Middle"
    Statistic.get_pims(hash)[2].player_team_stat[:playername].should eq "Highest"
  end

  it 'gets and sorts team-players' do
    Statistic.get_team_players(hash)[0].player_team_stat[:playername].should eq "Highest"
    Statistic.get_team_players(hash)[1].player_team_stat[:playername].should eq "Middle"
    Statistic.get_team_players(hash)[2].player_team_stat[:playername].should eq "Lowest"
  end
