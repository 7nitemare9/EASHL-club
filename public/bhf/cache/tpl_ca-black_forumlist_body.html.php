		...
		<div class="forabg">
			...
			<ul class="topiclist">
				<li class="header">
					<dl class="icon">
    				    <dt>
							<span style="float: right; margin-top: -5px;"><a href="#" onclick="ca_expand_forum(this, <?php echo $_forumrow_val['FORUM_ID']; ?>); return false;" class="forum-expand" id="forumblock<?php echo $_forumrow_val['FORUM_ID']; ?>"></a></span>
